     ...
     if(keysub > 0)
      {
        ...
        //console.log(addSubRow(keyd, 'm'+keyd));
          ...
          console.log("damage_parts["+keyd+"]["+keysub+"][part_name]");
           ...
           document.getElementsByName("damage_parts["+keyd+"]["+keysub+"][quantity_Est]")[0].value=valsub.quantity_Est;
           document.getElementsByName("damage_parts["+keyd+"]["+keysub+"][quantity_Asses]")[0].value=valsub.quantity_Asses;
