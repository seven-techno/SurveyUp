...
/*function newSpotPrivateSurvey() {

    var flag = "MOTOR - SPOT/ PRELIMINARY";
...
var currentDate = new Date();
    ...
    c=ans+"/"+year+"-"+nextYear+'/MOTOR-SPOT-PRIVATE';
